...
//------------------------------------------------------------------------------------------------------------------
    ...
    public void testKruskalAGM() {
        ...
        // Verificar que el número de aristas en el AGM sea correcto: número de nodos - 1
...
//------------------------------------------------------------------------------------------------------------------
    ...
    public void testGrafoVacio() {
        ...
        // Un grafo vacío debería tener un AGM vacío
        List<Aristas> arbolGeneradorMinimo = kruskalVacio.encontrarAGM();
        assertTrue(arbolGeneradorMinimo.isEmpty());
    }
...
//------------------------------------------------------------------------------------------------------------------  
    ...
    public void testAristasMismoPeso() {
        ...
        // Debería devolver 2 aristas, ya que el AGM solo necesita conectar los 3 nodos
...
//------------------------------------------------------------------------------------------------------------------   
    ...
    public void testGrafoConUnSoloNodoSinAristas() {
        ...
        // Un grafo con un solo nodo y sin aristas debería devolver un AGM vacío
        assertTrue(arbolGeneradorMinimo.isEmpty());
    }
...
//-----------------------------------------METODOS AUXILIARES----------------------------------------------------------
    ...
    // Método auxiliar para verificar si una arista está en la lista
